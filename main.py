...
finding.calculate_adjusted_risk_score()
#print(finding.adjusted_risk_score)

finding.determine_priority()
#print(finding.adjusted_priority)

#print(prod_firewall.calculate_environmental_adjustment())
#print(test_workstation.calculate_environmental_adjustment())
#print(finding.generate_reasoning())
finding.display_report()
print(finding.display_report)